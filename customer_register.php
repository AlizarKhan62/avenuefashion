...
<a href='localhost/ecommerce-website/customer/my_account.php?$customer_confirm_code'>
...
// Check if user has items in cart to determine redirect
...
// Always redirect to my account page after successful registration

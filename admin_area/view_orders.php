...
$order_date = isset($row_customer_order['order_date']) ? $row_customer_order['order_date'] : 'N/A';

$due_amount = isset($row_customer_order['due_amount']) ? $row_customer_order['due_amount'] : 0;
